...
#elif VERSION_US
u8 gPauseMsg_17[] = { 0x25, 0x53, 0x54, 0x41, 0x44, 0x81, 0x53, 0x54, 0x49, 0x43, 0x41, 0x53, 0xFD };                         // Estadísticas[End]
u8 gPauseMsg_18[] = { 0x2D, 0x45, 0x44, 0x41, 0x4C, 0x4C, 0x41, 0xFD };                                                       // Medalla[End]
u8 gPauseMsg_19[] = { 0x2F, 0x42, 0x4A, 0x45, 0x54, 0x4F, 0x53, 0xFD };                                                       // Objetos[End]
u8 gPauseMsg_1A[] = { 0x27, 0x52, 0x55, 0x50, 0x4F, 0xFD };                                                                   // Grupo[End]
u8 gPauseMsg_32[] = { 0x2D, 0x4F, 0x4E, 0x45, 0x44, 0x41, 0x53, 0xFD };                                                       // Monedas[End]
u8 gPauseMsg_33[] = { 0x30, 0x54, 0x53, 0x0E, 0xF7, 0x25, 0x53, 0x54, 0x52, 0x45, 0x4C, 0x4C, 0x41, 0xFD };                   // Pts. Estrella[End]
u8 gPauseMsg_34[] = { 0x30, 0x5A, 0x41, 0x0E, 0xF7, 0x25, 0x53, 0x54, 0x52, 0x45, 0x4C, 0x4C, 0x41, 0xFD };                   // Pza. Estrella[End]
u8 gPauseMsg_35[] = { 0x34, 0x50, 0x4F, 0x0E, 0xF7, 0x2A, 0x55, 0x45, 0x47, 0x4F, 0xFD };                                     // Tpo. Juego[End]
...
u8 gPauseMsg_3B[] = { 0x2E, 0x49, 0x4E, 0x47, 0x55, 0x4E, 0x41, 0xFD };                                                       // Ninguna[End]
u8 gPauseMsg_3C[] = { 0x22, 0x4F, 0x54, 0x41, 0x53, 0xFD };                                                                   // Botas[End]
u8 gPauseMsg_3D[] = { 0x33, 0x55, 0x50, 0x45, 0x52, 0x42, 0x4F, 0x54, 0x41, 0x53, 0xFD };                                     // Superbotas[End]
u8 gPauseMsg_3E[] = { 0x35, 0x4C, 0x54, 0x52, 0x41, 0x42, 0x4F, 0x54, 0x41, 0x53, 0xFD };                                     // Ultrabotas[End]
u8 gPauseMsg_3F[] = { 0x2E, 0x49, 0x4E, 0x47, 0x55, 0x4E, 0x4F, 0xFD };                                                       // Ninguno[End]
u8 gPauseMsg_40[] = { 0x2D, 0x41, 0x52, 0x54, 0x49, 0x4C, 0x4C, 0x4F, 0xFD };                                                 // Martillo[End]
u8 gPauseMsg_41[] = { 0x33, 0x55, 0x50, 0x45, 0x52, 0x4D, 0x41, 0x52, 0x54, 0x49, 0x4C, 0x4C, 0x4F, 0xFD };                   // Supermartillo[End]
u8 gPauseMsg_42[] = { 0x35, 0x4C, 0x54, 0x52, 0x41, 0x4D, 0x41, 0x52, 0x54, 0x49, 0x4C, 0x4C, 0x4F, 0xFD };                   // Ultramartillo[End]
u8 gPauseMsg_43[] = { 0x2D, 0x41, 0x52, 0x49, 0x4F, 0xFD };                                                                   // Mario[End]
u8 gPauseMsg_44[] = { 0x2E, 0x49, 0x56, 0x45, 0x4C, 0xFD };                                                                   // Nivel[End]
u8 gPauseMsg_46[] = { MSG_CHAR_UPPER_B, MSG_CHAR_UPPER_P, MSG_CHAR_READ_END };                                                // BP[End]
u8 gPauseMsg_47[] = { 0x34, 0x4F, 0x44, 0x41, 0x53, 0xFD };                                                                   // Todas[End]
u8 gPauseMsg_48[] = { 0x2D, 0x45, 0x44, 0x41, 0x4C, 0x4C, 0x41, 0x53, 0xFD };                                                 // Medallas[End]
u8 gPauseMsg_49[] = { 0x21, 0x43, 0x54, 0x49, 0x56, 0x41, 0x53, 0xFD };                                                       // Activas[End]
u8 gPauseMsg_4A[] = { 0x22, 0x30, 0xF7, 0x49, 0x4E, 0x53, 0x55, 0x46, 0x49, 0x43, 0x49, 0x45, 0x4E, 0x54, 0x45, 0x53, 0xFD }; // BP insuficientes[End]
u8 gPauseMsg_4B[] = { 0x8D, 0x2E, 0x4F, 0xF7, 0x4C, 0x4C, 0x45, 0x56, 0x45, 0x53, 0xF7, 0x4D, 0x78, 0x53, 0x01, 0xFD };       // ¡No lleves más![End]
u8 gPauseMsg_50[] = { 0x2F, 0x42, 0x4A, 0x45, 0x54, 0x4F, 0x53, 0xFD };                                                       // Objetos[End]
u8 gPauseMsg_4F[] = { 0x2F, 0x42, 0x4A, 0x45, 0x54, 0x4F, 0x53, 0xF7, 0x43, 0x4C, 0x41, 0x56, 0x45, 0xFD };                   // Objetos clave[End]
...
u8 gPauseMsg_55[] = { 0x28, 0x41, 0x42, 0x49, 0x4C, 0x49, 0x44, 0x41, 0x44, 0x45, 0x53, 0xFD };                               // Habilidades[End]
