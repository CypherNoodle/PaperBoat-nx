...
void quizmo_stage_appendGfx(void* effect) {
    ...
    if (data->unk_3C != 255) {
        Mtx* mtxLeft  = (Mtx*)LOAD_ASSET(D_09004148_39CD08);
        Mtx* mtxRight = (Mtx*)LOAD_ASSET(D_09004188_39CD48);
        Mtx* mtxRear  = (Mtx*)LOAD_ASSET(D_090041C8_39CD88);
        Mtx* mtxPodium = (Mtx*)LOAD_ASSET(D_09004208_39CDC8);
        gSPMatrix(gMainGfxPos++, mtxRear, G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
        ...
        gSPMatrix(gMainGfxPos++, mtxLeft, G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
        ...
        gSPPopMatrix(gMainGfxPos++, G_MTX_MODELVIEW);
        gSPMatrix(gMainGfxPos++, mtxRight, G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
        ...
        gSPMatrix(gMainGfxPos++, mtxPodium, G_MTX_PUSH | G_MTX_MUL | G_MTX_MODELVIEW);
