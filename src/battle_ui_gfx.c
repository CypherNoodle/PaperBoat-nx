...
// Battle UI assets loaded from OTR via assets/ui.h

// Stub display lists for unused battle menu entries
Gfx D_8028F860[] = { gsSPEndDisplayList() };
Gfx D_8028FC68[] = { gsSPEndDisplayList() };
Gfx D_80291C78[] = { gsSPEndDisplayList() };
