...
The normal engine log is `switch/paperboat/logs/Paperboat.log`. Temporary
startup checkpoints and `switch-startup.log` generation have been removed.
An old startup log on the SD card can be deleted manually.
